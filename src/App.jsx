      ...
      <main className="w-full pt-16">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="text-center">
            <button className="bg-indigo-600 hover:bg-indigo-700 text-white text-lg font-semibold py-3 px-8 rounded-md transition duration-150 ease-in-out transform hover:scale-105">
              Create Your Room
            </button>
          </div>
        </div>
